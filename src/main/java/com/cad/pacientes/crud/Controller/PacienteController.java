package com.cad.pacientes.crud.Controller;
...
import com.cad.pacientes.crud.Dto.DetalhamentoPacienteDto;
import com.cad.pacientes.crud.Dto.PacienteDadosDto;
import com.cad.pacientes.crud.Dto.PacienteDto;
import com.cad.pacientes.crud.model.PacienteModel;
import com.cad.pacientes.crud.repositories.PacienteRepository;
...
public class PacienteController {
	...
	@GetMapping
	public ResponseEntity<Page<PacienteDadosDto>> litar(@PageableDefault(size = 10, sort = {"nome"})  Pageable paginacao){
		var page = repository.findAll(paginacao).map(PacienteDadosDto :: new);
